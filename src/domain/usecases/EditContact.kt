...
class EditContact :  UseCase<EditContact.RequestValue, EditContact.ResponseValue, ErrorValue>() {
    data class RequestValue(val i: Int,val modified : String,val editposition :Int) : UseCase.RequestValue
    ...
    override suspend fun executeUseCase(requestValues: RequestValue): Result<ResponseValue, ErrorValue> {
        data.Contactsdata.editContact(requestValues.i,requestValues.modified,requestValues.editposition)
